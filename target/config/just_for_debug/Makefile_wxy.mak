...
bootrom : depend.VirtualBoxBSP bootInit.o romInit.o bootrom.Z.o \
		 libcplus.a libgnucplus.a libvxcom.a libvxdcom.a libarch.a libcommoncc.a libdrv.a libgcc.a libnet.a libos.a librpc.a libtffs.a libusb.a libvxfusion.a libvxmp.a libvxvmi.a libwdb.a libwind.a libwindview.a $(VXWORKS_BASE_DIR)/lib/libPENTIUMgnuvx.a 
	vxrm $@ 
#vxrm ldpentium -o $@ -Ttext  -Tdata  
	...
	ldpentium -X -N -e romInit -Ttext $(RAM_LOW_ADRS) \
		...
		bootrom.Z.o  \
		--start-group -L$(VXWORKS_BASE_DIR)/lib/pentium/PENTIUM/gnu -L$(VXWORKS_BASE_DIR)/lib/pentium/PENTIUM/common $(LIBS) --end-group \
		-T $(VXWORKS_BASE_DIR)/h/tool/gnu/ldscripts/link.RAM
...
bootrom_uncmp.elf : depend.VirtualBoxBSP bootInit_uncmp.o romInit.o \
	...
	$(LD) -X -N -e romInit \
	    ...
	    bootConfig.o sysALib.o sysLib.o --start-group $(LD_LINK_PATH) $(LIBS) --end-group\
	    -T $(VXWORKS_BASE_DIR)/h/tool/gnu/ldscripts/link.RAM
#d:\Tornado2.2\host\x86-win32\bin\romsize pentium -b $(ROM_SIZE) $@
	nm $@ > $@.nm
