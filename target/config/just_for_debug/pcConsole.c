...
--------------------
01d,06dec01,jlb  added option to send scan codes and set LEDs
01c,11jun96,wlf  doc: cleanup.
...
/******************************************************************************
*
* pcConDrv - initialize the console driver 
*
...
STATUS pcConDevCreate 
    ...
    if (tyDevInit (&pPcCoDv->tyDev, rdBufSize, wrtBufSize, vgaWriteString)!= OK)
	{
		return (ERROR);
	}
...
LOCAL STATUS pcConDrvIoctl 
	...
	case CONIOCONVERTSCAN:		 /* send scan codes or ASCII */
