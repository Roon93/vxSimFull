...
pcPentium3 BSP-specific versions of components and parameters defined in
...
Component INCLUDE_TIMESTAMP  {
    NAME              Pentium III high resolution timestamp driver
...
Parameter INCLUDE_TIMESTAMP_PIT2  {
    NAME              pcPentium3 configuration parameter
...
/*******************************************************************************
*
* pcPentium3 BSP-specific configuration folder
*
*/
Folder FOLDER_BSP_CONFIG  {
    NAME              pcPentium3 BSP configuration options
...
Component INCLUDE_POWER_MANAGEMENT  {
    NAME              Pentium III power management
    SYNOPSIS          initialize Pentium III power management support
...
/*******************************************************************************
*
* 815E and ICH2 Component and Parameters
*
*/
Component INCLUDE_D815EEA  {
    NAME              Pentium III + i815e + ICH2 (i82801BA) support
    SYNOPSIS          enable i815E with ICH2 (i82801BA) main board support
