...
INCLUDE FILES:
seqIo.h usbAudio.h usbSpeakerLib.h
*/
...
* ERRNO:
*
*   S_usbSpeakerLib_OUT_OF_RESOURCES
*   S_usbSpeakerLib_USBD_FAULT
*/
...
*
* ERRNO:
*   S_usbSpeakerLib_NOT_INITIALIZED
*/
...
*
* ERRNO:
*   S_usbSpeakerLib_BAD_PARAM
*   S_usbSpeakerLib_OUT_OF_MEMORY
*/
...
*
* ERRNO:
*   S_usbSpeakerLib_NOT_REGISTERED
*/
