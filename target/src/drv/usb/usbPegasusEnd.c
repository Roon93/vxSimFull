...
usbdLib.h usbLib.h usbPegasusEnd.h
...
LOCAL STATUS 	pegasusMCastFilterSet	(PEGASUS_DEVICE * pDevCtrl, 
                                        UINT8* pAddress, UINT32 noOfFilters );
...
LOCAL STATUS pegasusEndMCastDel
    ...
    if (etherMultiGet (&pDrvCtrl->endObj.multiList, pList) == ERROR)
	return ERROR;   
...
*
* ERRNO:
*   S_usbPegasusLib_BAD_PARAM
*   S_usbPegasusLib_OUT_OF_MEMORY
*/
...
* PEGASUS device attachment and removal.  The <callback> and <arg> paramters 
...
*
* ERRNO:
*   S_usbPegasusLib_NOT_REGISTERED
*/
...
* release the lock.
*
* NOTE: If the underlying Pegasus device has already been removed
...
*
* Reads the Register contents of PHY device.
*
* RETURNS: OK if successful or ERROR on Failure
*/
...
*
* This function will read the Register contents of Pegasus and print them for 
* debugging purpose.
*
* RETURNS: OK if successful or ERROR on Failure
*/
...
*
* Write the data into Registers of PHY device.
*
* RETURNS: OK if successful or ERROR on Failure
*/
...
/***************************************************************************
*
* usbPegasusReadSrom - Read the Contesnts of Serial EEPROM
*
