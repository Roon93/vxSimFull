...
--------------------
01b,05mar00,wef	Created - adapted from usbTool.
*/
...
/*************************************************************************
*
* usbAudioDemo - Entry point to USB audio demo
*
* RETURNS:  OK or ERROR
*/

extern STATUS usbAudioDemo (void)
    {
    int           fd;
    REQ_DIR_ENTRY rde;
    char * directoryName;
